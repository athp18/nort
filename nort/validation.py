...
def plot_likelihoods(
    df, threshold=0.6, session_name="Session", save_path=None, show=True
):
...
def warn_if_poor_quality(
    df, likelihood_threshold=0.6, max_low_confidence_pct=20.0, min_bodyparts_present=1
):
